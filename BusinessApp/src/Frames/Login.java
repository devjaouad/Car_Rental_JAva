...
public class Login extends javax.swing.JDialog {
    ...
    private void Login() {
        ...
        try {
            UserAccountList objUserAccountList = new UserAccountList();

            String usrname = this.usertxt.getText();
            String pwd = this.pwdtxt.getText();

            if (objUserAccountList.Authenticate(usrname, pwd)) {
                this.dispose();
                //This will take the UserAccount name to the MainMenu
                main.LoggesAsTxt.setText(usrname);
...
//    }
    ...
    private void initComponents() {
        ...
        usertxt.setBackground(new java.awt.Color(153, 255, 255));
        ...
        pwdtxt.setBackground(new java.awt.Color(153, 255, 255));
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Car-Rental.jpg"))); // NOI18N
